...
const Home = () => {
    ...
    return (
        <section className='home'>
            <div className='background-image-opacity bg-gradient-to-r row from-[rgb(1,66,106)] to-[#096aa6]  h-[652px] m-auto flex justify-center px-14  gap-5 flex-wrap ' >
                <div className='flex justify-center content-start flex-col gap-1 '>
                    ...
                    <div className=' text-md text-white pl-2'>
            ...
            <div className='flex justify-center bg-gradient-to-r row from-[#01426ac8] to-[#096aa6b3] py-10 px-10 gap-6 md:gap-6 flex-wrap md:flex-nowrap ' >

                <div className=' bg-gradient-to-r w-full md:w-[320px] h-full md:h-[500px] row from-[hsl(203,98%,21%)] to-[#096aa6] border border-1 border-solid border-black shadow-[#26292e] hover:shadow-black text-white px-8 py-4 rounded-2xl flex gap-2 flex-col transition-all ease-in-out duration-200 sm:hover:-translate-y-2 shadow-lg' >
                ...
                <div className='bgImg bg-gradient-to-r row from-[#096aa6] [rgb(1,66,106)] to-[rgb(1,66,106)]  border border-1 border-solid border-black shadow-[#26292e] hover:shadow-black text-white w:full  md:w-[500px] px-8 py-4 rounded-2xl flex gap-2 flex-col transition-all ease-in-out duration-200 sm:hover:-translate-y-2 shadow-lg'  >
                    <div className='text-xl sm:text-2xl font-semibold  text-yellow-600'>
