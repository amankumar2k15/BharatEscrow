      ...
      <section className='buySell border-y-2 border-white w-full'>
        ...
        <div className=' px-4 md:px-6 w-full py-10'>
          <div className=' flex flex-row flex-wrap justify-center gap-4'>
            ...
            <div className='bg-[#a3c7de] shadow-lg shadow-black hover:-translate-y-1 transition-all duration-300 ease-in-out text-black h-[430px] md:h-[470px] max-w-[400px] px-4 flex flex-col gap-y-4'>
              <h2 className='text-md mt-5 text-blue-900'>No ChargeBack vs Traditional Payment Processors</h2>
              <div className='md:h-[250px] md:max-w-[365px]' >
                <img className='md:h-[260px] md:w-[365px] object-cover' src={blogImg} alt='blogImg' />
              </div>
