        ...
        <>
            <div className='mt-40 container text-black mx-auto max-w-[800px] font-roboto  px-4 sm:px-10'>
                <div>
                    ...
                    <p className='text-md mt-8 px-2 text-slate-800'>Under no circumstances, including even if we are informed or advised of the possibility beforehand, shall the Company or any of its partners, vendors, service providers, affiliates, agents, or representatives be liable to you or anyone else for any losses, claims, and damages, including but not limited to any liability for consequential, special, incidental, direct or indirect, punitive or exemplary, or other damages of any kind (including lost revenue or profits, loss of business, or loss of dates).</p>

                    <p className='text-md mt-8 px-2 text-slate-800'>The content on the Website is general in nature and should not be interpreted as advice on any specific subject. Before acting on the information presented here, users are urged to see a professional. The user shall be solely responsible for making all decisions relating to any Assets, Goods, or Services, opportunity, nature, suitability, choice, or viability.</p>

                    <p className='text-md mt-8 px-2 text-slate-800 mb-10'>The Company is registered, controlled, and operated out of India, and the Company makes no claims that the Assets, Goods, and Services are suitable for use in other regions of the world or will be accessible elsewhere as well. If you access the Website from a location outside of India, you are solely responsible for adhering to all local laws as well as any applicable international agreements and treaties.</p>
